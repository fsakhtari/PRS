...
orig_file <- paste0(
  PRS_PHENO_DIR,
  "/raw_data/summary_stats/29273806-GCST005212-EFO_0000270.h.tsv"
)
...
# Obtained from $PRS_PHENO_DIR/raw_data/summary_stats/41588_2017_14_MOESM3_ESM.xlsx,
# as sum of 'Number of cases' and 'Number of controls'
n_cases <- 23948
n_controls <- 118538
